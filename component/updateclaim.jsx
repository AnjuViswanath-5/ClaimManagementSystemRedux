    ...
    let h2Style = {
      ...
      <form method="post" onSubmit= {this.submitLoginForm}> 
        ...
        <div className="form-group">
          ...
          <div className="col-sm-10">
            <input type="text" defaultValue={this.state.claimno} className="form-control" id="claimno" name="claimno" maxLength="9" onChange={this.handleChange}/>
          </div>
         ...
         <div className="form-group">
          ...
          <div className="form-group">
            ...
            <div className="col-sm-10">
              <input type="text" defaultValue={this.state.claimdesc} maxLength="20" className="form-control" id="claimpgm" name="claimpgm"  onChange={this.handleChange}/>
            </div>
